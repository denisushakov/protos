...
type LoginResponse struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // Auth token of the logged ih user.
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x5a, 0x14, 0x75, 0x73, 0x68, 0x61, 0x6b, 0x6f, 0x76, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31,
